...
const strings = {
  ru: {
    ...
    'config.asr.desc': 'Транскрипция голосовых через Faster-Whisper API.',
    ...
    'config.asr.url_desc': 'Endpoint Faster-Whisper API. Используйте host.docker.internal для хост-машины.',
    ...
    'services.stop': 'Остановить',
    'services.start': 'Запустить',
  ...
  en: {
    ...
    'config.asr.desc': 'Voice message transcription via Faster-Whisper API.',
    ...
    'config.asr.url_desc': 'Faster-Whisper API endpoint. Use host.docker.internal for host machine.',
